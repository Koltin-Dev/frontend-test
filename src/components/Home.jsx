...
const Home= () => {
    ...
    return (
       <section className={styles.homeContainer}>
        <section>
        <h1 className={styles.homeTitle}> Hi, I´m Liliana Hdez Front End Dev</h1>
        <p className={styles.homeParagraph}> On this blog I share tips and tricks, frameworks, projects, tutorials, etc.<br />
